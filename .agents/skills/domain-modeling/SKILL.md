...
When a term is resolved, update `@CONTEXT.md` right there. Don't batch these up -- capture them as they happen. Use the format in [`@CONTEXT.template.md`](./CONTEXT.template.md), [`@CONTEXT-MAP.template.md`](./CONTEXT-MAP.template.md).
...
If any of the three is missing, skip the ADR. Use the format in [`@ADR.template.md`](../write-adr/ADR.template.md).
